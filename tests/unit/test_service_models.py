...
class TestServiceCategory:
    ...
    def test_service_category_repr(self):
        ...
        category = ServiceCategory(id=1, business_id=1, name="Hair Services")
...
class TestService:
    ...
    def test_service_repr(self):
        ...
        service = Service(
            id=1, name="Haircut", duration_minutes=30, price=Decimal("25.00")
        )
...
class TestServiceAddon:
    ...
    def test_service_addon_repr(self):
        ...
        addon = ServiceAddon(
            id=1, name="Hair Wash", service_id=1, price=Decimal("5.00")
        )
...
class TestStaffService:
    ...
    def test_staff_service_effective_properties_without_overrides(self):
        ...
        staff_service = StaffService(staff_id=1, service_id=1, is_available=True)
        staff_service.service = service
    ...
    def test_staff_service_repr(self):
        ...
        staff_service = StaffService(id=1, staff_id=1, service_id=1, is_available=True)
