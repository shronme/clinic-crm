from sqlalchemy import Column, Integer, String, DateTime, Text, Boolean, ForeignKey, Index, Enum
...
class OverrideType(enum.Enum):
    ...
    UNAVAILABLE = "unavailable"  # Make staff unavailable during normally available times
...
class AvailabilityOverride(Base):
    ...
    # Relationships
    staff = relationship("Staff", foreign_keys=[staff_id], back_populates="availability_overrides")
    ...
    def __repr__(self):
        return (f"<AvailabilityOverride(id={self.id}, staff_id={self.staff_id}, "
